document.getElementById('main-content').innerHTML = `
  ...
  <form id="cvForm" class="bg-dark p-4 rounded border border-secondary">
    ...
    <div class="mb-3">
      <textarea class="form-control" id="objetivo" rows="3" placeholder="Descreva sua área de atuação e objetivo profissional..." required></textarea>
...
document.getElementById('cvForm').onsubmit = async (e) => {
  ...
  const camposObrigatorios = ['nome', 'email', 'telefone', 'objetivo', 'formacao'];
