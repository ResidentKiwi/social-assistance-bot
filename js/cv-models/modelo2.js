export default function () {
  document.getElementById('main-content').innerHTML = `
    <h2 class="mb-4"><i class="fas fa-id-card-alt me-2"></i> Currículo – Modelo Moderno</h2>
    <form id="cvForm" class="row g-3">
      ...
      <div class="col-12 text-end"><button type="submit" class="btn btn-success mt-3"><i class="fas fa-file-pdf me-2"></i> Gerar PDF (Modelo Moderno)</button></div>
    </form>
  `;
  ...
  document.getElementById('cvForm').onsubmit = async (e) => {
    ...
    const res = await fetch(`https://social-assistance-backend.onrender.com/cv/generate?modelo=modelo2`, {
      method: 'POST',
    ...
    a.download = "curriculo-modelo2.pdf";
    a.click();
  };
}
